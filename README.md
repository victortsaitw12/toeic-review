...
- **真題聽力（逐題快答）**（模擬考試分頁）— **EZ 模擬考 5 回＋國學聽力藍本 10 回**的
  ...
  皆為書末答案頁 OCR）的字母位置；尚未依題本掃描訂正的回數（藍本 C1／C2、C3–C5 的 Q32–43）
  圖表題選項為推測、解析有註記需對照題本，其餘（藍本 C6–C10、C3–C5 的 Q44–100）已換成題本原文。
...
- **TestC9（國學藍本 第 9 回）**——Part 1 全 6 題＋圖表題組 62–64、65–67、68–70、95–97、98–100（圖表題重繪 SVG；
  圖片與音檔為同版本，Q32–100 全數依題本掃描圖訂正，圖表題 63/66/69/97/99 用題本真正選項；
  Q39/Q45 的引述句原本引錯句子，已依題本改正）
- **TestC10（國學藍本 第 10 回）**——Part 1 全 6 題＋圖表題組 62–64、65–67、68–70、95–97、98–100（圖表題重繪 SVG；
  圖片與音檔為同版本，Q32–100 全數依題本掃描圖訂正，圖表題 63/67/70/96/100 用題本真正選項；
  五張圖表的內容取自「題目訂正」整頁掃描，第十回合圖片目錄只有 Part 1 六張照片）
