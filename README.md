...
- **EZ 真題聽力模擬考**（模擬考試分頁）— EZ Test 1–5 整回聽力：沿用聽力解析已切好的
  真人音檔照順序連播（含真實作答間隔，約 46 分鐘），線上答案卡作答 Part 1–4 共 100 題，
  交卷對 **EZ 官方答案卷**（`data/exam_ez.js`，由書末答案頁 OCR 而來，1–100 聽力、
  101–200 閱讀備用）。結果附各 Part 答對數並計入首頁最弱項目統計；檢討頁每段列
  正解／你的答案、附英中逐字稿，可跳去聽力解析重聽或把答錯段落一鍵收進聽力練習本。
  Part 1 圖片與 Part 3/4 選項需搭配紙本題本。
